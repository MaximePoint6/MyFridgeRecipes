...
class FoodSearchService {
    ...
    func fetchFoods() {
        AF.request("https://api.edamam.com/auto-complete?app_id=5079a296&app_key=7840a914a6fbc59f4e30d3473e2de567&q=tom&limit=10")
          .validate()
          .responseDecodable(of: [String].self) { (response) in
            guard let foods = response.value else { return }
            print(foods)
          }
